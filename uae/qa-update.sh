...
pwd
cp -fr /apps/hosting/configs/deploy/smart.tar.gz /backup/build/uae/qa/qa_build_`date -%d%m%y-%H`.tar.gz
#tar -czvf /backup/build/uae/qa/qa_build_`date -%d%m%y-%H`.tar.gz /apps/hosting/configs/deploy/
rm -fr /apps/hosting/configs/deploy/*
tar -czf /backup/code/uae/qa/qa_`date -%d%m%y-%H`.tar.gz /apps/hosting/configs/smart
