...
pkill node
DATE=`date +%d%m%Y-%H`
cd /Users/zoylomac/smart-uat-builds
mkdir $DATE
cd $DATE
...
export ROOT_URL=https://veritazuat.fieldrepo.com/
export PORT=2300
echo $MONGO_URL
echo $ROOT_URL
echo $PORT=2300
...
meteor --allow-superuser build ../APK --server https://veritazuat.fieldrepo.com
cd ../APK/android
