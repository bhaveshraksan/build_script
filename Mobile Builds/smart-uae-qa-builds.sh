...
pkill node
DATE=`date +%d%m%Y-%H`
cd /Users/zoylomac/smart-uae-qa-builds
mkdir $DATE
cd $DATE
...
export ROOT_URL=https://aple1gcuaeqa.fieldrepo.com
export PORT=2300
echo $MONGO_URL
echo $ROOT_URL
echo $PORT=2300
...
cp -fr settings.json /Users/zoylomac/settings-smqauae.json
meteor --allow-superuser add-platform android
export METEOR_SETTINGS=$(cat /Users/zoylomac/settings-smqauae.json)
meteor build ../APK --allow-superuser --server https://aple1gcuaeqa.fieldrepo.com
pwd
cd ../APK/android
...
export ROOT_URL=https://aple1gcuaeqa.fieldrepo.com
export METEOR_SETTINGS=$(cat /Users/zoylomac/settings-smqauae.json)
meteor run ios-device --allow-superuser --mobile-server $ROOT_URL --production --settings /Users/zoylomac/settings-smqauae.json
