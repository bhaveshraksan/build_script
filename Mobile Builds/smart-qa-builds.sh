...
pkill node
DATE=`date +%d%m%Y-%H`
cd /Users/zoylomac/smart-qa-builds
mkdir $DATE
cd $DATE
...
export ROOT_URL=https://veritazqa.fieldrepo.com
export PORT=2300
echo $MONGO_URL
echo $ROOT_URL
echo $PORT=2300
...
cp -fr settings.json /Users/zoylomac/settings-smqa.json
meteor --allow-superuser add-platform android
export METEOR_SETTINGS=$(cat /Users/zoylomac/settings-smqa.json)
meteor build ../APK --allow-superuser --server https://veritazqa.fieldrepo.com
cd ../APK/android
...
export ROOT_URL=https://veritazqa.fieldrepo.com
export METEOR_SETTINGS=$(cat /Users/zoylomac/settings-smqa.json)
meteor run ios-device --allow-superuser --mobile-server $ROOT_URL --production --settings /Users/zoylomac/settings-smqa.json
